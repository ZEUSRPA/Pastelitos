        ...
        <div id="" class="">
            <div class="m-19">
                ...
                <div class="row col-12">
                    ...
                    <h3 class="bg-red" v-if="selectedorders.length == 0">NO SE ENCONTRARON REGISTROS!!!</h3>
                    ...
                    <div class="pagination col-12">
                        ...
                        <div class="text-right col-8">
                            <h5 class="text-info ml-5">{{selectedorders.length}} registros encontrados</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default{
        ...
        methods:{
            ...
            updateTable(change){
                ...
                this.orders=this.selectedorders.slice(this.actualPage*this.pagination,this.actualPage*this.pagination+this.pagination);
            },
            updateTotalPages(){
                this.totalPages = Math.ceil(this.selectedorders.length/this.pagination);
            },
            ...
            setAddView(){
                window.location.href="/admin/pedidos/agregar";
            },
            setDetailsView(item){
                window.location.href="/admin/pedidos/"+item.id;

            },
            setEditView(item){
                this.editing=true;
                window.location.href="/admin/pedidos/editar/"+item.id;
            },
            sortTable(value){
                if(this.order === 1){
                    this.order=2;
